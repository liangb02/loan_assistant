...
$(function() {
    ...
    $("#serviceForm input, #serviceForm textarea").jqBootstrapValidation({
        preventSubmit: true,
        ...
        submitSuccess: function($form, event) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#success > .' + alertClass).html("<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;")
                        .append("</button>");
                    $('#success > .' + alertClass)
